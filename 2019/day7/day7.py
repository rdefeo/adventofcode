...
# Part 1
# For each permutation of the phase setting sequence, create a computer
# Then daisy-chain the output of one to the input of the next. The output
# of the last IntCode computer is our signal. Get the max signal.
max_out = 0
...
# Part 2
# Similar to the above, but use a different phase setting sequence as our
# input. Then, keep cycling outputs to inputs until a halt. Get the max.
max_out = 0
